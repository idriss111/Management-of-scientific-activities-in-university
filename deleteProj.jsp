    ...
    <body>
        <header id="main-header">
            <div class="container">
                ...
                <nav id="main-nav">
                    <ul>
                        <li><a href="Projets">Home</a></li>
                        <li><a href="ajouterProjet">Ajouter un projet</a></li>
                        <li><a href="${pageContext.request.contextPath}/">Modifier un projet</a></li>
                    </ul>
                </nav>
            </div>
        </header>
        ...
        <div class="container">
            ...
            <section id="content">
                <div class="add-form">
                    <h2>Supprimer votre projet de recherche</h2>
                    <form action="supprimerProjet" method="post"  enctype='multipart/form-data'>
                        <p>
                          <label><p class="title">Entrez le titre de projet à supprimer:</p> </label>
                        ...
                        <p style="color:red;">
                            <c:if test="${requestScope.existePas != null }" >
                            <c:out value="${requestScope.existePas}"></c:out>
                            </c:if>
                        </p>
