...
<head>
    ...
    <!-- x-editor CSS
		============================================ -->
    <link rel="stylesheet" href="../AdminFolder/css/editor/select2.css">
    <link rel="stylesheet" href="../AdminFolder/css/editor/datetimepicker.css">
    <link rel="stylesheet" href="../AdminFolder/css/editor/bootstrap-editable.css">
    <link rel="stylesheet" href="../AdminFolder/css/editor/x-editor-style.css">
    <!-- normalize CSS
		============================================ -->
    <link rel="stylesheet" href="../AdminFolder/css/data-table/bootstrap-table.css">
    <link rel="stylesheet" href="../AdminFolder/css/data-table/bootstrap-editable.css">
    <!-- style CSS
		============================================ -->
                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Dashboard v.3" href="index_admin.jsp"><span class="mini-sub-pro">Dashboard v.3</span></a></li>
