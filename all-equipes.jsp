...
<head>
    ...
    <title>All Equipe | Kiaalap - Kiaalap Admin Template</title>
    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <form action="searchEquipes" role="search" class="sr-input-func">
                                                <input name="search" type="text" placeholder="Search..." class="search-int form-control">
                                                <button href="${pageContext.request.contextPath}/searchEquipes" type="submit"></button>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Equipes</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <form action="listeChercheurs" method="post">
          <div class="contacts-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <c:forEach var="list" items="${equipes}">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <h3><a href="">${list.nom_equipe}</a></h3>
                                <p class="all-pro-ad"></p>
                                <p>
                                    
                                   Laboratoire : ${list.nom_labo} <br>
                                   Chef d'equipe: ${list.chefEquipe}<br>
