...
<body>
    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">delete equipe</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <form action="supprimerEquipe" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <input id="usr"  name="nomEquipe" type="text" class="form-control" placeholder="entrez le nom d'equipe a supprimer">
                    </div>
