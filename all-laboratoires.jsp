...
<head>
    ...
    <title>All Labos | Kiaalap - Kiaalap Admin Template</title>
...
<body>
    ...
    <div class="all-content-wrapper">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Laboratoires</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <form action="listeLaboratoires" method="post">
          <div class="contacts-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <c:forEach var="list" items="${labos}">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <h3><a href="">${list.nom_labo}</a></h3>
                                <p class="all-pro-ad"></p>
                                <p>
                                   Laboratoire : ${list.nom_labo} <br>
                                   Chef de labo: ${list.chef_labo}<br>
