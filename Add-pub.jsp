            ...
            <div class="container">
                ...
                <nav id="main-nav">
                    <ul>
                        ...
                        <li><a href="ajouterP">Single Post</a></li>
        ...
        <div class="container">
            ...
            <section id="content">
                <div class="add-form">
                    ...
                    <form action="ajouterPublication" method="post"  enctype='multipart/form-data'>
                        <p>
                          <label><p class="title">Titre de publication:</p> </label>
                            <input type="text"  name="titre" required>
                        </p>
                        
                        <p>
                          <label><p>Abstract :</p></label>
                            <textarea type="text" name="abstract" required placeholder="expliquez..."></textarea>
                        </p>
                        <p>
