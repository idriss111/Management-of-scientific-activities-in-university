  ...
  h3 {
    ...
    <body>
        ...
        <div class="container">
            ...
            <section id="content">
                <div class="add-form">
                    <h2>Supprimer votre publication</h2>
                    <form action="supprimerPublication" method="post"  enctype='multipart/form-data'>
                        <p>
                          <label><p class="title">Entrez le titre de publication à supprimer:</p> </label>
