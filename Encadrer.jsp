  ...
  h3 {
    ...
    <body>
        ...
        <div class="container">
            ...
            <section id="content">
                <div class="add-form">
                    <h2>Ajouter votre encadrement</h2>
                    <form action="encadrer" method="post"  enctype='multipart/form-data'>
                        <p>
                        ...
                        <p>
                            ...
                            <option value="these d'habilitation">these d'habilitation</option>
                            </select>
                        </p>
                         ...
                         <p>
                            ...
                            <br>
                            <select name="type_encad" required>
                        ...
                        <p>
                          ...
                          <label><p>l'étudiant à encadrer :</p></label>
                            <br>
                            <select name="encadre" required>
                                 <c:forEach items="${chercheurs}" var="chercheur">
								   <option value="">${chercheur.nom} ${chercheur.prenom} </option>
								</c:forEach>
                            </select>
                        </p>
                        <p>
                        ...
                        <br>
                        <p>
                            <input type="submit" value="Encadrer" id="button" href=""></input>
                        </p>
                    </form>
                </div><!-- add form -->
                <div class="push"></div>
