...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <form action="listeChercheurs" method="post">
          <div class="contacts-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <c:forEach var="list" items="${chercheurs}">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <img src="/Users/macbookpro/Downloads/contact_img1.png">
                                <h3><a href="">${list.username}</a></h3>
                                <p class="all-pro-ad"></p>
                                <p>
                                   Nom et prenom : ${list.prenom} ${list.nom}<br>
                                   Email: ${list.email}<br>
                                   Profession: ${list.profession}<br>
                                   Telephone: ${list.telephone}<br>
                            ...
                            <div class="panel-footer contact-footer">
                                <div class="professor-stds-int">
                                    ...
                                    <div class="professor-stds">
                                        <div class="contact-stat"><span>Equipe: </span> <strong>${list.nomEquipe }</strong></div>
                                    </div>
                                    <div class="professor-stds">
                                    </div>
                                </div>
