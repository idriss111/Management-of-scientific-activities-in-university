...
<body>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="${pageContext.request.contextPath}/logout"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><img src="AdminFolder/img/product/profile-bg.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="AdminFolder/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="AdminFolder/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="AdminFolder/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="AdminFolder/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="AdminFolder/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="AdminFolder/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="AdminFolder/img/product/book-4.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><img src="AdminFolder/img/courses/1.jpg" alt="" /></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © <a href="https://colorlib.com/wp/templates/">Colorlib</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- counterup JS
		============================================ -->
    <script src="AdminFolder/js/counterup/jquery.counterup.min.js"></script>
    <script src="AdminFolder/js/counterup/waypoints.min.js"></script>
    <script src="AdminFolder/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="AdminFolder/js/morrisjs/raphael-min.js"></script>
    <script src="AdminFolder/js/morrisjs/morris.js"></script>
    <script src="AdminFolder/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    ...
    <script src="AdminFolder/js/sparkline/sparkline-active.js"></script>
    <!-- calendar JS
		============================================ -->
