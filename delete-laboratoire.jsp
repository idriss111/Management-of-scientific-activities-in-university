...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <form action="supprimerLaboratoire" method="POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        <input id="usr"  name="nomLabo" type="text" class="form-control" placeholder="entrez le nom du laboratoire a supprimer">
                    </div>
